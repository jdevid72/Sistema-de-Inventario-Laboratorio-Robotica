        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="materialAdd">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <img :src="form.imagen" id="imgHide" style="width:80px;height:100px;display:none" class="image-fluid mb-1">
                                </div>
        ...
        methods:{
            materialAdd(){
                ...
                .then(res=>{
                    ...
                    Toast.fire({
                            icon: 'success',
                            title: 'Se Agrego Material Exitosamente'
